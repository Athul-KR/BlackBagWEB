...
<tr>
   <td colspan="2">
      <table style="width: 100%; padding: 20px; text-align: center; background: #ffffff; border: 1px solid #000; min-height: 350px;">
         ...
         <tr>
            <td>
               <h1 style="font-size: 26px; margin-top: 0;"><img style="width: 30px; margin-right: 7px;" src="<?php echo e(url('public/images/mail/nurse.png')); ?>">Welcome to BlackBag <br>Your Account is Ready!</h1>
            </td>
         </tr>
         ...
         <tr>
            <td style="text-align: left;">
               ...
               <p style="color: #6B6B6B; font-size: 14px; line-height: 1.5; font-weight: 300;">We are reaching out to inform you that BlackBag has sent you an invitation to join us as a clinic user. Blackbag is our online platform designed to support seamless collaboration between healthcare professionals and their patients.</p>
            </td>
         </tr>
      </table>
   </td>
...
<tr>
   <td colspan="2" style="text-align: center; padding-top: 30px;">
      ...
      <a href="{{route('nurse.invitation',[$nurse_uuid])}}" style="padding: 20px 10px; text-align: center; background: #000000; display: block; text-decoration: none; color: #fff; width: 200px; margin: auto; border-radius: 5px; margin-top: 15px;">Accept Invitation</a>
      */
      ?>
