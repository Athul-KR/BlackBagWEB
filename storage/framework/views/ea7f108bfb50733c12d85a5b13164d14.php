            ...
            <table class="table table-hover table-white text-start w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- <td><?php echo e($appointment->appointment_date > now()? '<p class="text-warning">Pending</p>'  :($appointment->deleted_at !==null ? '<p class="text-warning">Cancelled</p>': '<p class="text-danger">Expired</p>')); ?></td> -->
                        <?php endif; ?>
                    ...
                    <tr>
                        <td colspan="<?php echo e($status=='all'? '6':'5'); ?>" class="text-center">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="italic" id="appointmentNotesData">
...
<script>
    function notes(uuid) {
        ...
        var url = "<?php echo e(route('frontend.getNote')); ?>";
...
</script><?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/frontend/online-appointments.blade.php ENDPATH**/ ?>