<form id="appointment_create_form" method="post" action="<?php echo e(route('appointment.update')); ?>">
    <?php echo csrf_field(); ?>
    <div class="row mt-4">
        <div class="col-12">
            <!-- Appointment uuid Hidden field -->
            <input type="hidden" name="appointment_uuid" value="<?php echo e($appointment->appointment_uuid); ?>">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuLink">
                            ...
                            <div id="search_li">
                                ...
                                <li id="<?php echo e($patient['patients_uuid']); ?>" class="dropdown-item  select_patient_list" style="cursor:pointer">
                                    ...
                                    <div class="dropview_body profileList">
                                        ...
                                        <?php if($appointment->patient_id==$patient->id): ?>
                                        <input id="patient-id" type="hidden" value="<?php echo e($patient->id); ?>" data-content="<?php echo e($patient['name']); ?>">
                                        <?php endif; ?>
                                    </div>
                                </li>
        ...
        <div class="col-md-6">
            <div class="form-group form-outline mb-4 date" id="datepicker">
                ...
                <input id="appt-date" type="text" name="appointment_date" value="<?php echo e(date('m/d/Y', strtotime($appointment->appointment_date))); ?>" class="form-control" placeholder="">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group form-outline mb-4 time" id="timepicker">
                ...
                <input id="appt-time" type="text" name="appointment_time" value="<?php echo e(date('h:i:A', strtotime($appointment->appointment_time))); ?>" class=" form-control">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group form-outline form-dropdown mb-4">
                        ...
                        <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuLink">
                            ...
                            <li class="dropdown-item select_appointment_type_list">
                                <div class="dropview_body">
                                    ...
                                    <?php if($appointment->appointment_type_id==$appointmentType->id): ?>
                                    <input id="appointment_type-id" type="hidden" value="<?php echo e($appointmentType['id']); ?>" data-content="<?php echo e($appointmentType['appointment_name']); ?>">
                                    <?php endif; ?>
        ...
        <div class="col-md-6">
            <div class="form-group form-outline mb-4">
                ...
                <input type="text" value="<?php echo e($appointment->appointment_fee ? number_format($appointment->appointment_fee, 0) : ''); ?>" class="form-control" name="appointment_fee">
            </div>
        </div>
        <div class="col-12">
            <div class="form-group form-outline form-dropdown mb-4">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuLink">
                            ...
                            <div id="search_li_doctor">
                                ...
                                <li id="<?php echo e($doctor['consultant_uuid']); ?>" class="dropdown-item  select_doctor_list" style="cursor:pointer">
                                    ...
                                    <div class="dropview_body profileList">
                                        ...
                                        <?php if($appointment->consultant_id==$doctor->id): ?>
                                        <input id="doctor-id" type="hidden" value="<?php echo e($doctor->id); ?>" data-content="<?php echo e($doctor['name']); ?>">
                                        <?php endif; ?>
                            ...
                            <div id="search_li_nurse">
                                ...
                                <li id="<?php echo e($nurse['clinic_user_uuid']); ?>" class="dropdown-item  select_nurse_list" style="cursor:pointer">
                                    ...
                                    <div class="dropview_body profileList">
                                        ...
                                        <?php if($appointment->nurse_id==$nurse->id): ?>
                                        <input id="nurse-id" type="hidden" value="<?php echo e($nurse->id); ?>" data-content="<?php echo e($nurse['name']); ?>">
                                        <input id="nurse_uuid" name="nurse_uuid" type="hidden" value="<?php echo e($nurse['clinic_user_uuid']); ?>">
                                        <?php endif; ?>
        ...
        <div class="col-12">
            <div class="form-group form-outline form-textarea mb-4">
                ...
                <textarea class="form-control" name="note" rows="4" cols="4"><?php echo e($appointment->notes); ?></textarea>
            </div>
...
<!-- <script src="<?php echo e(asset('js/appointmentValidation.js')); ?>"></script> -->
...
<script>
    ...
    $(document).ready(function() {
        ...
        var url = "<?php echo e(route('appointment.update')); ?>";
        ...
        $('#appt-date').datetimepicker({
            format: 'MM/DD/YYYY',
            useCurrent: false, // Prevents setting current date by default
        ...
        $('#appt-time').datetimepicker({
            ...
            stepping: 10 // Optional: sets the minute interval (15 minutes in this case)
        });
...
</script><?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/appointment/edit.blade.php ENDPATH**/ ?>