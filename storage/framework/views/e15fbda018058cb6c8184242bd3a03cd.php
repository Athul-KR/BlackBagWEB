...
<head>
    ...
    <title><?php if(isset($seo['title'])): ?><?php echo e($seo['title']); ?>  <?php else: ?> BlackBag <?php endif; ?></title>
    ...
    <meta property="og:image" content="<?php echo e(asset('/images/og-img.png')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/colorbox.css')); ?>">
    ...
    <script src="<?php echo e(asset('js/jquery.colorbox.js')); ?>"></script>
            ...
            <div class="row align-items-center position-relative">
                <div  class="col-12 col-lg-4 d-lg-block d-none" >
                    ...
                    <div class="d-lg-none d-block d-flex justify-content-center mob-logo w-100">
                        <img src="<?php echo e(asset('images/loginlogo.png')); ?>" class="img-fluid logo_singin mb-4" alt="Logo">
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-8" >
                    <div class="card-body">
                        <div class="row" id="login">
                            <div class="col-12 position-absolute top-0 end-0"> 
                                <div class="btn_alignbox justify-content-end p-lg-0 p-3"> 
                                    <a class="primary fw-medium d-flex align-items-center gap-1" href="<?php echo e(url('/')); ?>"><span class="material-symbols-outlined">arrow_left_alt</span>Back to Website</a>
                                </div>
                            </div>
                                            ...
                                            <div class="tab-pane fade show active" id="number" role="tabpanel" aria-labelledby="number-tab">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-12">
                                                        ...
                                                        <input type="text"  name="first_name" class="form-control" id="exampleFormControlInput1" <?php if(!empty($clinicPatientDetails)): ?> value="<?php echo e($clinicPatientDetails['first_name']); ?>" <?php endif; ?>>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-12">
                                                        <div class="form-group form-outline mb-4">
                                                        ...
                                                        <i class="fa-solid fa-circle-user"></i>
                                                        <input type="text"  name="last_name" class="form-control" id="last_name" <?php if(!empty($clinicPatientDetails)): ?> value="<?php echo e($clinicPatientDetails['last_name']); ?>" <?php endif; ?>>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group form-floating mb-4">
                                                            ...
                                                            <select name="gender" id="gender" class="form-select">
                                                                <option value="">Select Gender</option>
                                                                    <option value="1" <?php if(!empty($clinicPatientDetails) && $clinicPatientDetails['gender'] == '1'): ?> selected <?php endif; ?>>Male</option>
                                                                    <option value="2" <?php if(!empty($clinicPatientDetails) && $clinicPatientDetails['gender'] == '2'): ?> selected <?php endif; ?>>Female</option>
                                                                    <option value="3" <?php if(!empty($clinicPatientDetails) && $clinicPatientDetails['gender'] == '3'): ?> selected <?php endif; ?>>Other</option>
                                                            </select>
                                                    ...
                                                    <div class="col-lg-6 col-12">
                                                        ...
                                                        <input type="text" name="dob" id="dob" class="form-control" <?php if(!empty($clinicPatientDetails) && isset($clinicPatientDetails['dob']) && $clinicPatientDetails['dob'] != ''): ?> value="<?php echo e(date('m/d/Y', strtotime($clinicPatientDetails['dob']))); ?>" <?php endif; ?>>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="email" name="email" id="email" class="form-control <?php if(!empty($clinicPatientDetails)): ?> disabled <?php endif; ?>" <?php if(!empty($clinicPatientDetails)): ?> value="<?php echo e($clinicPatientDetails['email']); ?>" <?php endif; ?>>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="phonenum_group">
                                                            <div class="country_code phone">
                                                                <input type="hidden" id="patientcountryCode" name="patient_countrycode"  value=<?php echo e(!empty($clinicPatientDetails) && isset($countryCodedetails['short_code'])  ? $countryCodedetails['short_code'] : 'US'); ?>>
                                                            ...
                                                            <div class="form-group form-outline mb-4 flex-grow-1">
                                                                <input type="tel" name="patient_phonenumber" class="form-control phone-number patient-phn  <?php if(!empty($clinicPatientDetails)): ?> disabled <?php endif; ?>" id="patientphonenumber" placeholder="Enter phone number" required <?php if(!empty($clinicPatientDetails) && isset($clinicPatientDetails['phone_number'])): ?> value="<?php echo isset($clinicPatientDetails['country_code'])  ? '+'.$clinicPatientDetails['country_code'] . $Corefunctions->formatPhone($clinicPatientDetails['phone_number']) : $Corefunctions->formatPhone($clinicPatientDetails['phone_number']) ?>" <?php endif; ?>>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <input type="hidden" name="invitationkey" id="invitationkey" value="<?php echo e($invitationkey); ?>">
                                                    ...
                                                    <div class="btn_inner">
                                                        <a class="primary fw-medium text-decoration-underline" href="<?php echo e(url('login')); ?>">Sign In</a>
                                                    </div>
                                                </form>
                        ...
                        <div class="row" id="otpform" style="display: none;">
                            <div class="col-12 position-absolute top-0 end-0"> 
                                <div class="btn_alignbox justify-content-end p-lg-0 p-3"> 
                                    <a class="primary fw-medium d-flex align-items-center gap-1 back-btn" href="<?php echo e(url('/')); ?>"><span class="material-symbols-outlined">arrow_left_alt</span>Back to Website</a>
                                </div>
                            </div>
                            <div class="col-md-8 col-lg-12 col-xl-10 col-xxl-8 mx-auto">
                        ...
                        <div class="row" id="patientsuccess" style="display: none;">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-10 col-xxl-8 mx-auto">
                                <div class="login-form text-center">
                                    ...
                                    <div class="mt-4">
                                        <img src="<?php echo e(asset('images/insurance_care.png')); ?>" class="care-img mb-3" alt="Care Us">
                                        <h4 class="text-center fw-medium mb-0">Help Us Care For You Better</h4>
                                        <p class="px-xl-5 px-lg-4">Share your health details to ensure personalized and accure care tailored to your needs.</p>

                                        <div class="btn_alignbox flex-column">
                                            <a id="loginsubmit" class="btn btn-primary w-100" href="<?php echo e(url('/intakeform')); ?>">Continue</a>
...
?>
   <!-- Correct script order -->
    ...
    <script type="text/javascript">
         function verifyOtp() {
            var invitationkey = "<?php echo e($invitationkey); ?>";
            var otpValue = '';
                            ...
                            if(data.type == 'patient'){
                                ...
                                if(data.isregister == '1'){
                                    ...
                                    setTimeout(function() {
                                        ...
                                        if (invitationkey != '') {
                                            window.location.href = "<?php echo e(url('/subscriptionplans')); ?>";
                                        }else{
                                            $("#patientsuccess").show();
                                        }
                                    ...
                                    if(data.hasRedirect == '0'){
                                        window.location.href = data.redirectURL;
                                            ...
                                            window.location.href = "<?php echo e(url('/myappointments')); ?>"; 
                                        }
                                }
        ...
        function resendOtp() {
            ...
            $.ajax({
                url: '<?php echo e(url("/submitlogin")); ?>',
                type: "post",
                data: {
                    'logintype' :logintype ,
                    'formdata': $("#verifyotpform").serialize(),
    ...
    errorMsg = $("#error-msg"),
    validMsg = $("#valid-msg");
    let onlyCountriesx = <?php echo json_encode($corefunctions->getCountry()); ?>;
    // initialise plugin
    ...
    <?php if(!empty($clinicPatientDetails)): ?>
        emailRules.remote = {
            url: "<?php echo e(url('/validateuserphone')); ?>",
            type: "post",
            data: {
                'type': 'patient',
                "id": "<?php echo e($clinicPatientDetails['user_id']); ?>",
...
<?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/auth/register-patient.blade.php ENDPATH**/ ?>