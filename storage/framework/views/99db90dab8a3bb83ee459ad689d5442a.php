                        <div class="text-center mb-3 px-lg-5 px-3">
                                    ...
                                    <div class="files-container justify-content-center mb-3">
                                      <div class="fileBody">
                                        ...
                                        <a href="<?php echo e(url('/doctors/download')); ?>" class="dwld-btn" ><span class="material-symbols-outlined me-1 primary">download</span></a>
                                      </div>
                                    </div>
                                    ...
                                    <label class="mb-2">Doctor</label>
                                      ...
                                      <form action="<?php echo e(url('/importdoctor')); ?>" class="dropzone mb-3" id="docupload" enctype="multipart/form-data">
...
$(document).ready(function () {
    var uplodURL = '<?php echo e(url("doctors/importdoctors")); ?>';
    ...
    function generatePreview(import_key) {
        window.location.href = "<?php echo e(url('doctors/excelpreview/')); ?>" +'/'+ import_key ;
        //   $('#import_preview').modal('show');
        //   showPreloader('import_preview_modal')
        //   $.ajax({
        //       url: '<?php echo e(url("/doctors/importpreview")); ?>',
        //       type: "post",
        //       data: {
...
<?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/doctors/import.blade.php ENDPATH**/ ?>