...
<div class="files-container justify-content-center mb-3">
    <div class="fileBody">
        <div class="file_info">
            <img src="<?php echo e(asset ('images/excel_icon.png')); ?>">
            <span>Sample Excel</span>
        </div>
        <a href="<?php echo e(route('nurse.downloadSampleDoc')); ?>" class="dwld-btn"><span class="material-symbols-outlined me-1 primary">download</span></a>
    </div>
</div>
...
<form action="<?php echo e(url('/import-nurse')); ?>" class="dropzone mb-3" id="docupload" enctype="multipart/form-data">
...
<script>
    $(document).ready(function() {
        var uplodURL = '<?php echo e(url("nurse/import-nurse")); ?>';
    ...
    function generatePreview(import_key) {
        window.location.href = "<?php echo e(url('nurse/excelpreview/')); ?>" +'/'+ import_key ;
        ...
        //     },
        //     url: '<?php echo e(url("/nurse/import-preview")); ?>',
        //     type: "post",
        //     data: {
...
</script><?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/nurses/import.blade.php ENDPATH**/ ?>