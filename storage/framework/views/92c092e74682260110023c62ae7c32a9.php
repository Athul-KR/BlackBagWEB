...
<div class="import_section add_img">
    <a href="#" id="nurse-import" data-nurse-import-url="<?php echo e(route('nurse.import')); ?>"
...
<form id="nurse-create-form" method="post" action="<?php echo e(route('nurse.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row">

        <div class="create-profile">
            <div class="profile-img position-relative">
                <img id="nurseimage" src="<?php echo e(asset('images/default_img.png')); ?>" class="img-fluid">
                <a href="<?php echo e(url('crop/nurse')); ?>" id="upload-img" class="aupload"><img id="doctorimg"
                ...
                email: {
                    ...
                    remote: {
                      ...
                      data: { 
                          ...
                          'clinic_id': function () {
                              return "<?php echo e(session('user.clinicID')); ?>"; 
                              }, 
...
<script src="<?php echo e(asset('js/placeholderPosition.js')); ?>"></script><?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/nurses/create.blade.php ENDPATH**/ ?>