                              ...
                              <div class="mt-4">
                                ...
                                <?php else: ?>
                                  ...
                                  <div class="text-center">
                                        ...
                                        <div class="text-center">
                                            <a  href=" <?php echo e(url('logout?redirectinvite=invitation/'.$invitationkey)); ?>"  class="btn btn-primary w-100">Logout</a>
                                        </div>
                                    </div>
                                    <?php else: ?>
                                    <div class="text-center">
...
function acceptInvitation(accept) {
    ...
    swal({
        ...
        if (isConfirmed) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('doctors/invitationstatuschange/'.$invitationkey)); ?>",
                data: {
                    'accept': accept,
                ...
                success: function(data) {
                    if (data.success == 1) {
                        window.location.href = "<?php echo e(url('login?')); ?>invitationkey=" + data.key;
...
<?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/invitation.blade.php ENDPATH**/ ?>