<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    <div class="col-12 my-3">
        <div class="tab_box">
            ...
            <button onclick="online('online','upcoming')" class="btn btn-tab <?php echo e($type == 'online' && $status == 'upcoming' ? 'active' : ''); ?>">Upcoming</button>
            <button onclick="online('online','expired')" class="btn btn-tab <?php echo e($type == 'online' && $status == 'expired' ? 'active' : ''); ?>" data-url="<?php echo e(route('appointment.appointmentList',['type'=>'online','status'=>'expired'])); ?>">Expired</button>
            <button onclick="online('online','cancelled')" class="btn btn-tab <?php echo e($type == 'online' && $status == 'cancelled' ? 'active' : ''); ?>" data-url="<?php echo e(route('appointment.appointmentList',['type'=>'online','status'=>'cancelled'])); ?>">Cancelled</button>
            <button onclick="online('online','all')" class="btn btn-tab <?php echo e($type == 'online' && $status == 'all' ? 'active' : ''); ?>">All</button>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-white text-start w-100">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $appointmentsOnline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <?php if(session('user.userID')== $appointment->created_by): ?>
                            <div class="d-flex align-items-center justify-content-end btn_alignbox">
                                <a class="btn opt-btn border-0" data-bs-toggle="tooltip" title="Start Video Call"><img src="<?php echo e(asset('images/vediocam.png')); ?>"></a>
                                <a class="btn opt-btn border-0" onclick="notes('<?php echo e($appointment->appointment_uuid); ?>')" data-bs-toggle="modal" data-bs-target="#appointmentNotes" data-bs-dismiss="modal" data-bs-toggle="tooltip" title="Note"><img src="<?php echo e(asset('images/file_alt.png')); ?>"></a>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li class="appt-li">
                                        <a id="edit-appointment" data-appointmenturl="<?php echo e(route('appointment.edit',[$appointment->appointment_uuid])); ?>?type=<?php echo e($type); ?>&status=<?php echo e($status); ?>&user_type=<?php echo e('nurse'); ?>" data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-target="#editAppointment" class="dropdown-item fw-medium">
                                    ...
                                    <?php if($status === 'upcoming' || $status === 'expired' || $status === 'all' && $appointment->deleted_at == null): ?>
                                    <li>
                                        <a data-appointmenturl="<?php echo e(route('appointment.delete',[$appointment->appointment_uuid,'type'=>$type,'status'=>$status,'user_type'=>'nurse','key'=>$nurse->clinic_user_uuid])); ?>" class="delete-appt dropdown-item fw-medium"><i class="fa-solid fa-trash-can me-2"></i>Cancel Appointment
                                        </a>
                                    </li>
                                    <?php endif; ?>
                                    ...
                                    <li>
                                        <a data-appointmenturl="<?php echo e(route('appointment.activate',[$appointment->appointment_uuid,'type'=>$type,'status'=>$status,'user_type'=>'nurse','key'=>$nurse->clinic_user_uuid])); ?>" class="activate-appt dropdown-item fw-medium">
                    ...
                    <?php if($appointmentsOnline->isEmpty()): ?>
                    <tr>
    ...
    <div class="col-12">
        <div class="row">
            <!-- <?php if($appointmentsOnline->isNotEmpty()): ?>
            <div class="col-md-6">

                <form method="GET" action="<?php echo e(route('nurse.view',[$nurse])); ?>">
                    <div class="sort-sec">
            ...
            <?php endif; ?> -->
            <div class="col-md-6">
                <?php echo e($appointmentsOnline->links('pagination::bootstrap-5')); ?>
...
</script><?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/nurses/online-appointment-list.blade.php ENDPATH**/ ?>