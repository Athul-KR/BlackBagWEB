<?php $__env->startSection('title', 'For Doctors'); ?>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="content_box">
                    <small class="primary">Join Our Doctors Community</small>
            ...
            <div class="col-lg-6">
                <div class="image-container text-center mt-lg-0 mt-3">
                    <img src="<?php echo e(asset('frontend/images/find_doc_banner.png')); ?>" class="img-fluid doc-banner">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row h-100">
            ...
            <div class="col-lg-4 col-12 mb-lg-0 mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        <img class="card-img-top mb-3" src="<?php echo e(asset('frontend/images/card1.png')); ?>" alt="Card image cap">
            ...
            <div class="col-lg-4 col-12 mb-lg-0 mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        <img class="card-img-top mb-3" src="<?php echo e(asset('frontend/images/card2.png')); ?>" alt="Card image cap">
            ...
            <div class="col-lg-4 col-12">
                <div class="card h-100">
                    <div class="card-body">
                        <img class="card-img-top mb-3" src="<?php echo e(asset('frontend/images/card3.png')); ?>" alt="Card image cap">
    ...
    <div class="container">
        <div class="row align-items-center mb-4 parallax-scroll">
            <div class="col-lg-6 col-12 order-1 order-lg-0">
                <div class="content_box">
                    <small>Seamless Virtual Consultations</small>
            ...
            <div class="col-lg-6 col-12 order-0 order-lg-1">
                <div class="image-container">
                    <img src="<?php echo e(asset('frontend/images/health_convice.png')); ?>" class="img-fluid">
                </div>
            </div>
        </div>
        <div class="row align-items-center mb-4 parallax-scroll">
            <div class="col-lg-6 col-12">
                <div class="image-container pe-lg-4">
                    <img src="<?php echo e(asset('frontend/images/flexible.png')); ?>" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-6 col-12">
                <div class="content_box">
    ...
    <div class="container">
        <div class="info_wrapper doctor-info position-relative overflow-hidden">
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="content_box">
                        <small>Empower Your Virtual Practice</small>
                        ...
                        <a class="btn btn-outline-primary">Get Started</a>
                    </div>
                </div>
                <div class="col-lg-6 col-12">
                    <div class="image-container position-absolute bottom-0">
                        <img src="<?php echo e(asset('frontend/images/find_resource.png ')); ?>" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/frontend/for-doctors.blade.php ENDPATH**/ ?>