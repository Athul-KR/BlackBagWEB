...
<section class="banner-container vedio-banner m-0 pt-0">
    <video autoplay muted loop playsinline class="" oncontextmenu="return false">
        <source src="<?php echo e(asset('frontend/images/banner-bg.mp4')); ?>" type="video/mp4">
    </video>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-lg-10 col-xxl-9 mx-auto">
                <div class="content_box text-center mt-lg-0 mt-5">
                    ...
                    <p class="white sub-text lg-font my-3">The first AI-powered system built from the ground up for the concierge practitioner.</p>
                    <a class="btn btn-outline-primary" href="<?php echo e(url('getstarted')); ?>">Try BlackBag Today !</a>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-12 order-1 order-lg-0">
                <div class="content_box">
                    ...
                    <a class="btn btn-outline-primary blue-shadow" href="<?php echo e(url('getstarted')); ?>">Get Started</a>
                </div>
            </div>
            <div class="col-lg-6 col-12 order-0 order-lg-1">
                <div class="image-container">
                    <img src="<?php echo e(asset('frontend/images/simplify.webp')); ?>" class="img-fluid" alt="Top Specialists">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-12">
                <div class="image-container">
                    <img src="<?php echo e(asset('frontend/images/automate.webp')); ?>" class="img-fluid" alt="Schedule Appointments">
                </div>
            </div>
            <div class="col-lg-6 col-12">
                <div class="content_box ps-lg-5">
                    ...
                    <a class="btn btn-outline-primary" href="<?php echo e(url('getstarted')); ?>">Get Started</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="even-section">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-12 order-0 order-lg-1">
                <div class="image-container">
                    <img src="<?php echo e(asset('frontend/images/tailored_care.webp')); ?>" class="img-fluid" alt="Highly Qualified Doctors">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="row align-items-center mb-5 ai-data mt-lg-5 mt-1 pt-3">
                            <div class="col-lg-7 col-md-12">
                                <div class="text-lg-start text-center">
                                    <img src="<?php echo e(asset('frontend/images/blackbag_scribe.png')); ?>" class="img-fluid " alt="">
                                </div>
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6 col-md-12">
                                <div class="ai-card">
                                    <img src="<?php echo e(asset('frontend/images/ai-img-a.png')); ?>" class="img-fluid " alt="Blackbag">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="ai-card">
                                    <img src="<?php echo e(asset('frontend/images/ai-img-b.png')); ?>" class="img-fluid " alt="Blackbag">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="ai-card">
                                    <img src="<?php echo e(asset('frontend/images/ai-img-c.png')); ?>" class="img-fluid " alt="Blackbag">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="ai-card">
                                    <img src="<?php echo e(asset('frontend/images/ai-img-d.png')); ?>" class="img-fluid " alt="Blackbag">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="ai-card">
                                    <img src="<?php echo e(asset('frontend/images/ai-img-e.png')); ?>" class="img-fluid " alt="Blackbag">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="ai-card-sub ai-card-left position-relative">
                                    <div class="inner-aicard">
                                        <img src="<?php echo e(asset('frontend/images/ai-img-f.png')); ?>" class="img-fluid " alt="Blackbag">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="ai-card-sub ai-card-right position-relative">
                                    <div class="inner-aicard">
                                        <img src="<?php echo e(asset('frontend/images/ai-img-g.png')); ?>" class="img-fluid " alt="Blackbag">
    ...
    <div class="container">
        <div class="info_wrapper blue_box text-center">
            <div class="content_box">
                ...
                <h3 class="my-3">Transform Your Concierge Medical Practice Today</h3>
                <p class="primary mb-3">Experience the future of concierge medicine with BlackBag. Let us handle the complexities of practice management while you deliver top-tier healthcare.</p>
                <a class="btn btn-outline-primary blue-shadow" href="<?php echo e(url('getstarted')); ?>">Get Started</a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('frontend.master_website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/frontend/home.blade.php ENDPATH**/ ?>