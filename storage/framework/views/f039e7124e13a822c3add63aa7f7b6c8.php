                      ...
                      <tbody>
                          ...
                          <?php $__currentLoopData = $excelDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index =>  $doct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="rmv_doc_<?php echo e($doct['import_doc_uuid']); ?>" class="rmv_doc_<?php echo e($doct['import_doc_uuid']); ?>">  
                              ...
                              <td><?php if(isset($designationDeatils[$doct['designation_id']]) && (!empty($designationDeatils[$doct['designation_id']])) ): ?> <?php echo e($designationDeatils[$doct['designation_id']]['name']); ?> <?php else: ?> -- <?php endif; ?></td>
                              <td><?php echo e($doct['qualification']); ?></td>

                              <td><?php if(isset($specialtyDetails[$doct['specialty_id']]) && (!empty($specialtyDetails[$doct['specialty_id']])) ): ?> <?php echo e($specialtyDetails[$doct['specialty_id']]['specialty_name']); ?> <?php else: ?> -- <?php endif; ?></td>
                              ...
                              <?php endif; ?>
                              <td class="text-end"><a class="danger" href="javascript:void(0);"   onclick="removeDocument('<?php echo e($doct['import_doc_uuid']); ?>')"><span class="material-symbols-outlined">delete</span></a></td>
...
<?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/doctors/preview.blade.php ENDPATH**/ ?>