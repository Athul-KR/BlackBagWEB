...
<body class="bg-white">
    ...
    <section <?php if($userType == 'patient'): ?> class="signin-page patient-signin-page" <?php else: ?> class="signin-page client-signin-page" <?php endif; ?>>
        <div class="container-fluid p-0">
            <div class="row align-items-center position-relative">
                <div <?php if($userType == 'patient'): ?> class="col-12 col-lg-4 d-lg-block d-none" <?php else: ?> class="col-12 col-lg-6" <?php endif; ?>>

                    <div <?php if($userType == 'patient'): ?> class="patient-sign-in-left-sec" <?php else: ?> class="sign-in-left-sec" <?php endif; ?>>
                ...
                <div <?php if($userType == 'patient'): ?> class="col-12 col-lg-8" <?php else: ?> class="col-12 col-lg-6" <?php endif; ?> >
                    <div class="card-body">
                                                ...
                                                <form method="POST" id="loginformuser" autocomplete="off">
                                                    ...
                                                    <div class="phonenum_group">
                                                        ...
                                                        <div class="form-group form-outline mb-4 flex-grow-1">
                                                            <input type="tel" name="phonenumber" class="form-control phone-number" id="phonenumber" placeholder="Enter phone number" <?php if(isset($phone) && $phone !='' ): ?> value="<?php echo $phone ?>" <?php endif; ?> required>
                                                        </div>
                                                    </div>
        
                                                    <input type="hidden" name="invitationkey" id="invitationkey" class="form-control" value="<?php if(isset($_GET['invitationkey']) && $_GET['invitationkey'] !=''): ?><?php echo e($_GET['invitationkey']); ?><?php endif; ?>">
                                                    <input type="hidden" name="userType" id="userType" class="form-control" value="<?php echo e($userType); ?>">

        
                                                    <a id="sendotp" onclick="submitLogin()" class="btn btn-primary w-100">Send OTP</a>
                                                    <p class="m-0 mt-5">Don't have a BlackBag account?</p>
                                                    <div class="btn_inner">
                                                        <a class="primary fw-medium text-decoration-underline" onclick="signUp('<?php echo e($userType); ?>')">Sign Up</a>
                                                    </div>
                                                </form>
                    ...
                    <div class="col-12">
                        <div class="login-form text-center ">
                            <form class="" id="loginemailform" autocomplete="off">
                                <input type="hidden" class="form-control"  id="timezoneOffset" name="timezoneOffset" >
                                <a href="<?php echo e(url('login/google')); ?>" class="btn btn-outline d-flex align-items-center justify-content-center  w-100 mb-3"><img src="<?php echo e(asset('images/googleImg.png')); ?>" class="img-fluid">Continue with Google</a>
                                <p class="my-4">OR</p>
    ...
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img src="<?php echo e(asset('images/success_signin.png')); ?>" class="img-fluid">
...
<div class="modal login-modal fade" id="successphoneverify" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img alt="Blackbag" src="<?php echo e(asset('images/invite-img.png')); ?>" class="img-fluid">
...
<div class="modal login-modal fade" id="signin" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content overflow-hidden">
            <div class="modal-header modal-bg p-0 position-relative">
                <img src="<?php echo e(asset('images/signin-bg.png')); ?>" class="img-fluid rounded-3" alt="">
                <a href="#" data-bs-dismiss="modal" aria-label="Close"><span class="material-symbols-outlined">close</span></a>
            </div>
            <div class="modal-body">
                      ...
                      <input value="clinic" name="value-radio" id="value-1" type="radio" />
                        <label for="value-1" class="justify-content-between">
                            <div class="userTypeInner">
                                <img src="<?php echo e(asset('images/clinic.png')); ?>" class="img-fluid">
                        ...
                        <label for="value-2" class="justify-content-between">
                            <div class="userTypeInner">
                                <img src="<?php echo e(asset('images/patient.png')); ?>" class="img-fluid">
                                <div class="userTypeInfo">
...
$(document).ready(function() {
    ...
    if (xhr.status === 419) {
        ...
        function showOTPPage(){
            ...
            $("#otpform").show();
            $('#otp1').focus();
            $("#otpkey").val("<?php echo e(Session::get('tempuser.otpkey')); ?>");
            $("#phonenumbers").val("<?php echo e(Session::get('tempuser.phonenumbers')); ?>");
            $("#countrycode").val("<?php echo e(Session::get('tempuser.countrycode')); ?>");
            $("#countryCodeShorts").val("<?php echo e(Session::get('tempuser.countryCodeShorts')); ?>");
            $('#otpPhone').text("<?php echo e(Session::get('tempuser.countrycode')); ?>" + ' ' + "<?php echo e(Session::get('tempuser.phonenumbers')); ?>");
            $("#userTypes").val('clinics');
            $("#isregister").val('1');
            let otp = "<?php echo e(Session::get('tempuser.otp')); ?>"
            Swal.fire({
                icon: 'success',
                title: '',
            ...
            $.ajax({
                url: "<?php echo e(URL::to('cleartempuser/')); ?>",
                type: "POST",
                data: {
        ...
        $(document).ready(function() {
            var isRegisterOtp = "<?php echo e(Session::get('tempuser.isregister')); ?>";
            if(isRegisterOtp == '1'){
                showOTPPage(); 
            }
            ...
            var telInput = $("#phonenumber"),
                ...
                errorMsg = $("#error-msg"),
                validMsg = $("#valid-msg");
                let onlyCountries = <?php echo json_encode($corefunctions->getCountry()); ?>;
                let initialCountryCode = "<?php echo e($countrycode->short_code ?? 'us'); ?>";
            // initialise plugin
                            ...
                            if(data.type == 'patient'){
                                ...
                                if(data.isregister == '1'){
                                    ...
                                    if(data.hasRedirect == '0'){
                                        ...
                                        window.location.href = "<?php echo e(url('/patient/dashboard')); ?>"; 
                                    }
                                }
                                 ...
                                 if(data.isregister == '1'){
                                    ...
                                    setTimeout(function() {
                                        ...
                                        window.location.href = "<?php echo e(url('/onboarding')); ?>" ;
                                    }, 2000); // 2 seconds

                                 }else{
                                 
                                    if(data.hasRedirect == '2'){
                                        window.location.href = "<?php echo e(url('doctor/onboarding')); ?>/"+data.lastStep ;
                                    }else if(data.hasRedirect == 0){
                                        window.location.href = "<?php echo e(url('/connecttostripe')); ?>?redirectURL=" + encodeURIComponent(data.redirectURL);
                                    }else{
...
<?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/auth/login.blade.php ENDPATH**/ ?>