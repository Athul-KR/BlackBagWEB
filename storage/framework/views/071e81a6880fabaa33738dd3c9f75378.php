                              ...
                              <div class="mt-4">
                                ...
                                <h1 class="mb-3">Welcome Back</h1>
                                  ...
                                  <div class="text-center">
                                        ...
                                        <div class="text-center">
                                            <a  href=" <?php echo e(url('logout?redirectinvite=invitation/'.$key.'/doctor')); ?>"  class="btn btn-primary w-100">Logout</a>
                                        </div>
                                    </div>
                                    <?php else: ?>
                                    <div class="text-center">
...
function acceptInvitation(accept) {
    var alreadyLoggined = "<?php echo e($alreadyLoggined); ?>";
    ...
    swal.fire({
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.success == 1) {
                            window.location.href = "<?php echo e(url('login?')); ?>invitationkey=" + data.key + "&type=doctor";
                        } 
                    ...
                    error: function(xhr, status, error) {
                        reject('An error occurred: ' + error); // Handle AJAX error
                    }
                });
            });
        }
        ...
        if (result.isConfirmed) {
            ...
            swal.fire('Cancelled', 'Your response has not been recorded.', 'error');
        }
    }).catch((error) => {
...
<?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/doctors/invitation.blade.php ENDPATH**/ ?>