...
<form method="POST" id="loginformuser">
    <?php echo csrf_field(); ?>
    <!-- <a href="" class="btn btn-outline-gray d-flex align-items-center justify-content-center w-100 mb-3"><img src="<?php echo e(asset('frontend/images/google_icon.png')); ?>" class="img-fluid me-2" width="25"><small>Continue with Google</small></a>
    ...
    <input type="hidden" name="invitationkey" id="invitationkey" class="form-control"
        value="<?php if(isset($_GET['invitationkey']) && $_GET['invitationkey'] != ''): ?><?php echo e($_GET['invitationkey']); ?><?php endif; ?>">
...
</script><?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/frontend/patient-login.blade.php ENDPATH**/ ?>