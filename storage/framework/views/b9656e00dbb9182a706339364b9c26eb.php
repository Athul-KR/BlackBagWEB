...
<script type="text/javascript" src="<?php echo e(asset('jcrop/js/jquery.Jcrop.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('jcrop/js/jquery.color.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('js/dropzone/dropzone.js?v=1')); ?>"></script>
<link rel="stylesheet" href="<?php echo e(asset('css/style.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('jcrop/css/jquery.Jcrop.min.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/dropzone/dropzone.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('js/dropzone/dist/min/basic.min.css')); ?>">
...
<script>
	$(document).ready(function () {
		...
		var accepted = "<?php echo e($acceptedFiles); ?>";
...
<div id="preloadview" class="prelod" style="display:none;">
	<img src="<?php echo url('public/img/twppre.gif'); ?>">
</div>
<div id="mydataone">
	<!DOCTYPE html>
	...
	<body class="cropwrp">
		...
		<div class="UPerror"><?php echo e($data['error']); ?></div>
		...
		<div id="drphide">
			<?php if($data['view'] == 1): ?>
					...
					<form method="POST" action="<?php echo e(url('crop/' . $data['type'] . '/' . $data['count'])); ?>"
						class="edit-form dropzone" id="uploadImg" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>
						<div class="fallback">
						...
						<input type="hidden" name="imtype" value="<?php echo e($data['type']); ?>" />
						<input type="hidden" name="cropview" value="<?php echo e($data['cropview']); ?>" />
						<input type="hidden" id="uldoctypeimage" name="doctype" value="" />
					</form>
					<div class="help-list">
						...
						<ul>
							...
							<?php else: ?>
								<li>Upload the logo in either JPG or PNG format.</li>
								<!-- <li>The maximum file size is <?php echo e($data['imageSizes']["width"]); ?> * <?php echo e($data['imageSizes']["height"]); ?> pixels.</li>	 -->
								<!-- <li>The logo is displayed at exactly <?php echo e($data['imageSizes']["width"]); ?> * <?php echo e($data['imageSizes']["height"]); ?> pixels; therefore, the recommended image size that you upload is exactly <?php echo e($data['imageSizes']["width"]); ?> * <?php echo e($data['imageSizes']["height"]); ?> pixels.</li> -->
		...
		<?php if($data['view'] == 2): ?>
			...
			<form method="POST" action="<?php echo e(url('crop/' . $data['type'] . '/' . $data['count'])); ?>" id="cropcreate"
				...
				<input type="hidden" name="imagekey" value="<?php echo e($data['imagekey']); ?>" />
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<img src="<?php echo e($data['imageLink']); ?>" id="target" alt="Crop" />
					</div>

					<left class="upboxbtnwrp" style="padding: 0 15px;">

						<?php if($data['cropview'] == 1): ?>
		...
		<?php if($data['view'] == 3): ?>
			...
			<?php if($data['type'] == 'logo'): ?>
				<script>
					parent.logoImage('<?php echo e($data['imagekey']); ?>', '<?php echo e($data['imagePath']); ?>');
					parent.$.fn.colorbox.close();
				</script>

			<?php elseif($data['type'] == 'doctor'): ?>
				<script>
					parent.doctorImage('<?php echo e($data['imagekey']); ?>', '<?php echo e($data['imagePath']); ?>');
					parent.$.fn.colorbox.close();
				</script>
			<?php elseif($data['type'] == 'nurse'): ?>
				<script>
					parent.nurseImage('<?php echo e($data['imagekey']); ?>', '<?php echo e($data['imagePath']); ?>');
					parent.$.fn.colorbox.close();
				</script>
			<?php elseif($data['type'] == 'clinic_logo'): ?>

				<script>
					parent.clinicLogoImage('<?php echo e($data['imagekey']); ?>', '<?php echo e($data['imagePath']); ?>', '<?php echo e($data['imgName']); ?>');
					parent.$.fn.colorbox.close();
				</script>
			<?php elseif($data['type'] == 'clinic_banner'): ?>
				<script>
					parent.clinicBannerImage('<?php echo e($data['imagekey']); ?>', '<?php echo e($data['imagePath']); ?>'), '<?php echo e($data['imgName']); ?>';
					parent.$.fn.colorbox.close();
				</script>

			<?php elseif($data['type'] == 'patient'): ?>
				<script>
					parent.patientImage('<?php echo e($data['imagekey']); ?>', '<?php echo e($data['imagePath']); ?>');
					parent.$.fn.colorbox.close();
				</script>
			<?php elseif($data['type'] == 'patient_doc'): ?>
				<script>
					parent.patientDoc('<?php echo e($data['imagekey']); ?>', '<?php echo e($data['imagePath']); ?>');
					parent.$.fn.colorbox.close();
				</script>
			<?php else: ?>
				<script>
					parent.profileImage('<?php echo e($data['imagekey']); ?>', '<?php echo e($data['imagePath']); ?>', '<?php echo e($data['filesize']); ?>');
					parent.$.fn.colorbox.close();
				</script>
...
</div><?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/crop.blade.php ENDPATH**/ ?>