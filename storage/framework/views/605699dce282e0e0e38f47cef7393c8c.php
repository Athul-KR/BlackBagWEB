...
<body class="bg-white">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="text-center mt-2">
                                                <a href=" <?php echo e(url('logout?redirectinvite=invitation/'.$key.'/nurse')); ?>" class="btn btn-primary w-100">Logout</a>
                                            </div>
                                        </div>
                                        <!-- <?php echo e($clinicnurseDetails); ?> -->
                                        <!-- If user already created -->
                                        <?php elseif($clinicnurseDetails ==null): ?>
                                        ...
                                        <div class="text-center mt-2">
                                            <a href=" <?php echo e(url('/logout')); ?>" class="btn btn-primary w-100">Login</a>
                                        </div>
                                        ...
                                        <div id="invite-url" class="btn_alignbox flex-row" data-url="<?php echo e(route('nurse.invitationStatusChange',['key'=>$key])); ?>">
    ...
    <script type="text/javascript">
        function invitationStatusChange(accept) {
            ...
            var alreadyLoggined = "<?php echo e(session()->has('user')); ?>";
                ...
                swal({
                    ...
                    .then((result) => {
                        if (result) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo e(URL::to('nurse/invitation-status-change/'.$key)); ?>",
                                data: {
    ...
    </script><?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/nurses/invitation.blade.php ENDPATH**/ ?>