<form method="post" id="change_phone_form">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-12">
            ...
            <div class="form-group form-outline phoneregcls mb-3">
                ...
                <input type="tel" name="phonenumber" placeholder="Phone Number" class="form-control" id="phoneeditinput"
                    value="<?php echo e($countryCode->country_code . $patient['phone_number'] ?? $patient['phone_number']); ?>">
            </div>
...
<script>
    ...
    function changePhoneNumber() {
        ...
        if ($("#change_phone_form").valid()) {
            ...
            var url = "<?php echo e(url('frontend/changePhoneNumber')); ?>";
    ...
    function resendOtp() {
        ...
        $.ajax({
            url: '<?php echo e(url("frontend/changePhoneNumber")); ?>',
            type: "post",
            data: {
    ...
    function verifyOtp() {
        ...
        if ($("#verifyotpform").valid()) {
            $.ajax({
                url: '<?php echo e(url("frontend/verifyotp?tokn=update")); ?>',
                type: "post",
                data: {
                    'formdata': $("#verifyotpform").serialize(),
                    '_token': $('input[name=_token]').val()
...
</script><?php /**PATH D:\Xampp\htdocs\blackbag\resources\views/frontend/change-phone-modal.blade.php ENDPATH**/ ?>