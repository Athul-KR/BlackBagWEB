...
<?php 
    ...
    ?>
                     @if(!empty($orderLists['data']))
                    @foreach ($orderLists['data'] as $orderList)
                        ...
                        <td class="text-end">
                            <div class="d-flex align-items-center justify-content-end btn_alignbox">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <a id="view-appointment" onclick="showPrintView('{{$orderList['lab_test_uuid']}}')"  class="dropdown-item fw-medium">
                                        ...
                                        <li>
                                            <a id="" onclick="deleteTest('catogory','{{$orderList['lab_test_uuid']}}','1')" class="dropdown-item">
        ...
        <div class="row justify-content-end">
            ...
            <div class="col-lg-6">
                <div class="sort-sec">
                    ...
                    <select name="perPage" id="perPage" class="form-select d-inline-block" aria-label="Default select example" onchange="getAppointmentMedicalHistory('labs')">
            ...
            <div class="col-lg-6">
                <div id="pagination-links">
                    {{ $orderListsArray->links('pagination::bootstrap-5') }}
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.pagination a', function(e) {
                ...
                getAppointmentMedicalHistory('labs',page)
            });
        });
    </script>
