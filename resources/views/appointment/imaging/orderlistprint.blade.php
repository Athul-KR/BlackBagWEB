                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="btn_alignbox">
                        @if(isset($isback) && $isback == '1')
                        <a href="javascript:void(0);" class="btn btn-outline-primary btn-align" id="orderbckbtn" onclick="editImagingOrder('{{$labkey}}');">
            ...
            <div class="preview-container">
                                            ...
                                            <div class="categorycls_{$labTestId}}">
                                               ...
                                               @if(isset($items['subcategories']))
                                                ...
                                                <div class="catgry-sub mb-2">
                                                    <div class="row align-items-center">
                                                        <div class="col-9">
                                                            @if(isset($categoryDetails[$item['subcategory_id']]))
                                                            <p class="primary fw-medium mb-0"> {{$categoryDetails[$item['subcategory_id']]['name']}}  @if(isset($item['options']) && !empty($item['options'])) ({{ implode(', ', $item['options']) }}) @endif  @if($item['is_contrast'] !='')({{ $item['is_contrast'] ? 'With Contrast' : 'Without Contrast' }}) @endif </p>
                                                            @endif
                                ...
                                <div class="col-6">
                                    <div class="text-start"> 
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <p class="primary fw-middle mb-0">@if(!empty($imagingList)) <?php echo $corefunctions->timezoneChange($imagingList['test_date'],"m/d/Y") ?> @else --  @endif</p>
                                        </div>
                ...
                <div class="btn_alignbox justify-content-end mt-3">
                    <a href="{{ url('imaging/print/'.$labkey.'?is_download=1') }}" target="_blank" class="btn btn-outline-primary btn-align"><span class="material-symbols-outlined">download</span>Download</a>
                    <a  href="{{ url('imaging/print/'.$labkey) }}" target="_blank" class="btn btn-primary btn-align"><span class="material-symbols-outlined">print</span>Print Order</a>
                </div>
