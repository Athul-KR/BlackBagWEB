                                        ...
                                        <div class="outer-wrapper box-cnt-inner">
                                            ...
                                            <div class="accordion accordion-flush" id="accordionFlushExample1">
                                                ...
                                                <h2 class="accordion-header position-relative" id="{{$headingId}}">
                                                    ...
                                                    >
                                                        ...
                                                        <div class="row align-items-center collapse-header w-100">
                                                            <div class="col-12 col-lg-10">
                                                                <div class="d-flex flex-lg-row flex-column align-items-lg-center align-items-baseline gap-4">
                                                    ...
                                                    @if(isset($mnds['created_by']) && $mnds['created_by'] == Session::get('user.userID') && isset($mnds['video_scribe']) && ($mnds['video_scribe'] != '1'))
                                                        <div class="position-absolute top-0 end-0 me-2 z-1">
                                                            <div class="btn_alignbox" style="position: absolute; top: 0.5rem; right: 1.7rem; z-index: 10; pointer-events: auto;">
