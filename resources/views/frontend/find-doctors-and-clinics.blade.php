            ...
            <div class="col-10 mx-auto">
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-2 col-12 text-center">
                        <a href="{{route('frontend.searchResults')}}" class="btn btn-primary mb-xl-0 mb-4">Search</a>
                    </div>
                    <div class="col-12">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div id="doctor-slider" class="owl-carousel">
                    ...
                    <div class="post-slide">
                        <div class="post-img">
                            <img src="{{asset('frontend/images/slide3.png')}}" alt="Paediatrics">
                        </div>
                        <div class="content_box text-center mt-3">
                            <h4>Paediatrics</h4>
                           <a href="" class="primary d-flex justify-content-center align-items-center text-decoration-underline">Consult Now<span class="material-symbols-outlined">chevron_right </span></a>
                    ...
                    <div class="post-slide">
                        <div class="post-img">
                            <img src="{{asset('frontend/images/slide5.png')}}" alt="Gynaecology">
                        </div>
                        <div class="content_box text-center mt-3">
                            <h4>Gynaecology</h4>
                           <a href="" class="primary d-flex justify-content-center align-items-center text-decoration-underline">Consult Now<span class="material-symbols-outlined">chevron_right </span></a>
    ...
    <div class="container">
        <div class="row align-items-center mb-4">
            <div class="col-lg-6 col-12 order-1 order-lg-0">
                <div class="content_box">
                    <p>Join Our Doctors Community</p>
            ...
            <div class="col-lg-6 col-12 order-0 order-lg-1">
                <div class="image-container">
                    <img src="{{asset('frontend/images/nos.webp')}}" class="img-fluid" alt="Community">
                </div>
            </div>
        </div>
    </div>
