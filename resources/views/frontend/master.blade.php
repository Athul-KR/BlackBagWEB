...
<head>
    ...
    <link rel="icon" href="{{ asset('frontend/images/favicon.png')}}" sizes="64x64" type="image/png">
...
<body>
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-xl fixed-top p-3 nav-topbar">
            <a href="{{route('frontend.index')}}"><img src="{{ asset('frontend/images/logo.png')}}" class="img-fluid logo-main"
                    alt="BlackBag Logo">
            </a>
            ...
            @if (session()->has('user') && session()->get('user.userType') == 'patient')
                <div class="notfctn-hd">
                    <div class="btn-group dropdown">
                        <button type="button" class="btn dropdown-toggle d-flex position-relative" data-bs-toggle="dropdown" aria-expanded="false"  onclick="getNotificationsList();">
                   ...
                   @endif
                            ...
                            <h4 class="text-center primary">Notifications</h4>
                            <a href="#" class="gray" data-bs-dismiss="modal" aria-label="Close"><small>Clear All</small></a>
                            </div>
                            <li class="unread">
                              <div class="d-flex">
                                  <img src="images/johon_doe.png" class="img-fluid">
                                  <div class="ntfcn_inner ms-2">
                                      <div>
                                          <small><a class="primary">John Doe</a> is waiting in the reception room for 5 mins</small>
                                          <div class="text-start pt-2">
                                              <small class="gray">1 min</small>
                                          </div>
                                      </div>
                          ...
                          <li>
                              <div class="d-flex">
                                  <img src="images/patient1.png" class="img-fluid">
                                  <div class="ntfcn_inner ms-2">
                                      <div>
                                          <small><a class="primary">Alejandro González </a> has cancelled their appointment</small>
                                          <div class="text-start pt-2">
                                            <small class="gray">23 min</small>
                                        </div>
                                      </div>
                                  </div>
                              </div>
                            ...
                            <li>
                              <div class="text-center w-100">
                                <a class="view-more-btn primary fw-medium" href="">View All</a>
                              </div>
                            </li> -->
                                        ...
                                        <button type="button" class="dropdown-btn dropdown-toggle" data-bs-toggle="dropdown"
                                            ...
                                            <div class="profile_wrapper">
                                                <div class="profile_innerbody">
                                                    @php
                                                    $userLogo = (session('user.image_path') != '') ? session('user.image_path') : asset('images/default_img.png');

                                                        //dd(session()->get('user.userLogo'));
                                                    @endphp
                                                    <img class="pfl-img" src="{{$userLogo}}" alt="Profile Image">

                                                </div>
                                                <div class="pftl-txt-hd pftl-txt">
                                                    <span>Welcome</span>
                                                    <h6 class="primary fwt-bold mb-0">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end profile-drpdown p-0">
                                            <?php /* <li>
                                                <div class="profile_wrapper">
                                                    <div class="profile_innerbody">
                                                        <img class="pfl-img"
                                                            src="{{session('user.image_path') ?? asset('images/default_img.png')}}">
                                                    </div>
                                                    <div class="pftl-txt-hd pftl-txt">
                                                        <h6 class="primary fwt-bold mb-0">{{session()->get('user.firstName')}}
                                                            {{session()->get('user.lastName')}}
                                                        </h6>
                                                        <span>{{session()->get('user.country_code') . " "}}
                                                            {{session()->get('user.phone')}}</span>
                                                    </div>
                                                </div>
                                            </li> -->
                                            <!-- <li>
                                                <div class="switch_workspace border-top border-bottom w-100">
                                                    <div class="workspace_text py-2 px-3">
                                                        ...
                                                        <h6 class="fw-bold m-0 primary">{{Session::get('user.clinicName')}}</h6>
                                                    </div>
                                                </div>
                                            </li> -->
                                           ...
                                           <li class="pb-2">
                                            <a onclick="changeClinic()"> <span class="material-symbols-outlined ">cached</span>Switch Clinic</a>
                                          </li>
                                            @endif
                                            <!-- <li><a onclick="showSettingsModal();"><span
                                                        class="material-symbols-outlined">settings</span>Settings</a></li> -->
                                            <li class="pt-0">
                                                <form method="get" action="{{route('logout')}}">
                                                    <a href="{{route('frontend.logout')}}"><span class="material-symbols-outlined">logout</span>Logout</a>
                                                </form>
                                            </li>
                                        </ul>
                                    </div>
                ...
                <!--
                  @if(env('app_env') != 'production')
                    <a class="btn btn-primary ms-lg-3" href="{{url('login')}}" >Back to Dashbrd</a>
                  @endif
                -->
            ...
            <div class="collapse navbar-collapse justify-content-lg-center order-xl-0 order-1" id="navbarNav">
                <ul class="navbar-nav mb-2 mb-lg-0 mt-xl-0 mt-3">
                    ...
                    <li class="nav-item {{request()->routeIs('frontend.dashboard') ? 'active': ''}}" ><a href="{{route('frontend.dashboard')}}" class="nav-link">Dashboard</a></li>
                    <li class="nav-item {{request()->routeIs('frontend.myAppointmentsTemplate') ? 'active': ''}}" ><a href="{{route('frontend.myAppointmentsTemplate')}}" class="nav-link">My Appointments</a></li>
                    
                     <li class="nav-item {{request()->routeIs('frontend.chats') ? 'active': ''}}" ><a href="{{route('frontend.chats')}}" class="nav-link">Chats</a></li>
                    
                    <li class="nav-item {{request()->routeIs('frontend.medicalhistory') ? 'active': ''}}"><a href="{{url('medicalhistory')}}" class="nav-link">Medical History</a></li> 
                    <li class="nav-item {{request()->routeIs('frontend.filecabinet') ? 'active': ''}}"><a href="{{url('filecabinet')}}" class="nav-link">File Cabinet</a></li> 
                    <!-- <li class="nav-item {{request()->routeIs('payment.myReceipt') ? 'active': ''}}"><a href="{{url('myreceipts')}}" class="nav-link">My Receipts</a></li> -->
                    <li class="nav-item {{request()->routeIs('frontend.myaccounts') ? 'active': ''}}"><a href="{{url('myaccounts')}}" class="nav-link">My Account</a></li>
                    @else
                    ...
                    <li class="nav-item {{request()->routeIs('frontend.forDoctors') ? 'active': ''}}">
                        <a class="nav-link" href="{{route('frontend.forDoctors')}}">For Doctors</a>
                    </li>
                    <li class="nav-item {{request()->routeIs('frontend.forClinics') ? 'active' : ''}}">
                        <a class="nav-link" href="{{route('frontend.forClinics')}}">For Clinics</a>
                    </li>
                    <li class="nav-item {{request()->routeIs('frontend.pricing') ? 'active' : ''}}">
                    ...
                    <?php /* <!--
                            ...
                            -->*/?>
                    <li class="nav-item {{request()->routeIs('frontend.contactUs') ? 'active' : ''}}">
    ...
    <div class="modal login-modal fade" id="loader" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img src="{{ asset('images/loader.gif')}}" class="img-fluid"  alt="Loader">
                </div>
            </div>
        </div>
    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="btn_alignbox justify-content-center">
                                                    <input type="hidden" name="uuid"
                                                        value="{{session()->get('user.patientID')}}">
   ...
   <div class="modal login-modal fade" id="registerUser" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    if (xhr.status === 419) {
        ...
        function showSettingsModal(){
            ...
            $('#settingsModal').on('shown.bs.modal', function () {
                // $('#loaderset').html('<div id="settingsloader" class="justify-content-center py-5"><img src="{{ asset("images/loader.gif") }}" width="250px"></div>');
                // profileUpdate();
                deleteAccount();
            });
        }
        ...
        function submitLogin(type) {
            ...
            if ($("#loginformuser").valid()) {
                ...
                var url = "{{url('frontend/submitlogin')}}";
    ...
    <script>
        ...
        function registerUser() {
            ...
            $("#registerClinicForm").html( '<div class="d-flex justify-content-center py-5">' + '<img src="{{ asset('images/loader.gif') }}" width="250px"  alt="Loader">' + '</div>');
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success == 1) {
                            ...
                            setTimeout(function () {
                                window.location.href = "{{ url('/login') }}"; // Redirect to the dashboard
        ...
        function getCards(){
            var url = "{{route('frontend.getcards')}}";
            $('#v-pills-cards').html('');
        ...
        function deleteAccount() {
            $('#v-pills-home').html('<div id="settingsloaderdelete" class="justify-content-center py-5"><img src="{{ asset("images/loader.gif") }}" width="250px"  alt="Loader"></div>');
            $('#v-pills-home').removeClass('active');
            $('#v-pills-home').removeClass('show');
            $('#v-pills-home-tab').removeClass('active');
            $('#v-pills-home-tab').removeClass('show');
        ...
        function showPhoneNumberModal() {
            var url = "{{route('frontend.showPhoneNumberModal')}}";

            $("#change_phone_modal").html(
                '<div class="d-flex justify-content-center py-5">' + '<img src="{{ asset('images/loader.gif') }}" width="250px"  alt="Loader">' + '</div>');
        ...
        function createPatient() {
            ...
            var url = "{{route('frontend.createPatient')}}";
        ...
        function addClinic() {
          $.ajax({
            url: '{{ url("add/workspace?type=frontend") }}',
            type: "post",
            data: {
              '_token': $('meta[name="csrf-token"]').attr('content')
            },
        ...
        function showLogin() {
            $("#patient_login_modal").html( '<div class="d-flex justify-content-center py-5">' + '<img src="{{ asset('images/loader.gif') }}" width="250px"  alt="Loader">' + '</div>');
          $.ajax({
            url: '{{ url("frontend/show-login") }}',
            type: "post",
            data: {
              '_token': $('meta[name="csrf-token"]').attr('content')
            },
        ...
        function joinMeet(appoinment_uuid) {
          ...
          $('#videomeet').html('<div class="d-flex justify-content-center py-5"><img src="{{ asset("images/loader.gif") }}" width="250px"  alt="Loader"></div>');
        ...
        function joinSession(appointmentUuid) {
            ...
            window.open("{{ url('meet/') }}" + "/" + appointmentUuid, "_blank");
