...
<head>
    ...
    <meta property="og:image" content="@if(isset($seo['og_image']) && $seo['og_image']!= ''){{asset($seo['og_image'])}}@else{{asset('/images/og-blackbag.png')}}@endif">
    <!-- CSS -->
...
<body>
    ...
    @endif
    <header class="@if(isset($ishome) && $ishome == '1') home-nav @endif">
        <nav class="navbar navbar-expand-xl fixed-top p-3 nav-topbar">
            <a href="{{route('frontend.index')}}" class="logo-section">
                <img @if(isset($ishome) && $ishome == '1') src="{{ asset('frontend/images/blackbagwhite.png')}}" @else src="{{ asset('frontend/images/logo.png')}}" @endif class="img-fluid logo-main" alt="BlackBag Logo">
            </a>
            <a href="{{route('frontend.index')}}" class="home-logo">
                <img src="{{ asset('frontend/images/logo.png')}}" class="img-fluid logo-main" alt="BlackBag Logo">
            </a>
            ...
            <div class="d-flex align-items-center gap-xl-3 gap-2 order-xl-1 order-0">
                ...
                @if (session()->has('user') )
                    ...
                    @if(session()->get('user.userType') == 'patient')
                        ...
                        <a class="btn btn-primary" href="{{url('patient/dashboard')}}" >Access BlackBag</a>
                    @else
                        <a class="btn btn-primary" href="{{url('dashboard')}}">Access BlackBag</a>

                    @endif
                      @endif
                @endif
                 @if (!session()->has('user') )
                <a class="btn btn-primary" href="{{url('login')}}" >Login/Sign Up</a>
                    @endif
