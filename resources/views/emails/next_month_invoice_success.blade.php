...
<tr>
    <td colspan="2">
        <table style="width: 100%; padding: 20px; text-align: center; background: #ffffff; border: 1px solid #000; min-height: 350px;">
            ...
            <tr>
                <td>
                    <h1 style="font-size: 26px; margin-top: 0;"><img style="width: 30px; margin-right: 7px;" src="{{url('public/images/mail/nurse.png')}}" alt="Logo">ePrescribe Renewal Success<br></h1>
                </td>
            </tr>
            ...
            <tr>
                <td style="text-align: left;">
                    ...
                    <p style="color: #6B6B6B; font-size: 14px; line-height: 1.5; font-weight: 300;margin-bottom:0px">We’re pleased to inform you that your ePrescribe subscription has been successfully renewed for {{ $nextMonthName }}.</p>
                </td>
            </tr>
