         ...
         <tr>
            <td colspan="2">
               <table style="width: 100%; padding: 20px; text-align: center; background: #ffffff; border: 1px solid #000;  min-height: 350px;">
                  ...
                  <tr>
                     <td>
                        <h1 style="font-size: 26px; margin-top: 0;"><img  style="width: 30px; margin-right: 7px;" src="{{asset('images/mail/image_shedule.png')}}"> Appointment Rescheduled</h1>
                     </td>
                  </tr>
                  ...
                  <tr>
                     <td align="left">
                        ...
                        <p style="color: #6B6B6B; font-size: 16px; line-height: 1.5; margin-bottom: 0;margin: 5px 0px">Your appointment with {{$patient}} has been rescheduled. Please find the details below:</p>
                     </td>
                  </tr>
                  ...
                  <tr>
                     <td style= "text-align: left;">
                        <table style="width: 100%;">
                           ...
                           <tr>
                              <td style="font-size: 14px; color: #6B6B6B; padding-top: 15px;">Clinic</td>
                              <td style="padding-top: 15px;"><p style="text-align: end; font-size: 16px; font-weight: 600; margin: 0;font-size: 15px;">{{$clinic}}</p></td>
                           </tr>
                           <tr>
                              <td style="font-size: 14px; color: #6B6B6B; padding-top: 15px;">Patient</td>
                              <td style="padding-top: 15px;"><p style="text-align: end; font-size: 16px; font-weight: 600; margin: 0;font-size: 15px;">{{$patient}}</p></td>
                           </tr>
                           <tr>
