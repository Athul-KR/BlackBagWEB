                              ...
                              <tr>
                                 <td>
                                    <h1 style="font-size: 26px; margin-top: 0;">
                                       <img style="width: 30px; margin-right: 7px; vertical-align: top;" src="{{url('public/images/mail/paymentsuccess.png')}}">Device Order Confirmation</h1>
                                 </td>
                              </tr>
                              <tr>
                                 <td style="text-align:left">
                                       <p style="color: #6B6B6B; font-size: 16px; line-height: 1.5; margin-bottom: 0; text-align: left;">Hi <span style="color: #181818;font-weight: 500;">{{$username}}</span>,<br/></p>
                                       <p>We are happy to inform you that medical device has been ordered for you. Please see the details below :</p>
                                 </td>
                              </tr>
                              <tr>
                                 <td style="text-align: left;">
