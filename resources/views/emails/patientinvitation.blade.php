                           ...
                           <table style="width: 100%; padding: 20px; text-align: center; background: #ffffff; border: 1px solid #000; min-height: 350px;">
                              ...
                              <tr>
                                 <td style="text-align: left;">
                                    ...
                                    <p style="color: #6B6B6B; font-size: 14px; line-height: 1.5; font-weight: 300;">You are invited to join us on our online platform designed to support seamless collaboration between healthcare professionals and their patients.</p>
