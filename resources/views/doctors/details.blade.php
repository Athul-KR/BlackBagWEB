            ...
            <div class="col-12 mb-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb d-inline-flex justify-content-center justify-content-sm-start">
                        <li class="breadcrumb-item"><a href="{{route('doctor.list')}}" class="primary">Users</a></li>
                                ...
                                <div class="d-flex flex-xl-row flex-column align-items-center"> 
                                    ...
                                    <div class="user_details text-start border-left border-right px-4"> 
                                        <div class="innercard-info mb-2">
                                            ...
                                            <small>{{$doctorDetails['qualification']}}</small>
                                        </div>
                                        <div class="innercard-info mb-2">
                            ...
                            <div class="col-12">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link appointments active" id="pills-home-tab" onclick="getAppointments('open','{{$doctorDetails['clinic_user_uuid']}}')"  role="tab" aria-controls="pills-home" aria-selected="true">Appointments</button>
                                    </li>
                                </ul>
...
function editDoctor(key) {
    ...
    $(document).ready(function() {
        ...
        getAppointments(status,key);

    });
//Function to show the appointments, online and offline in view page
    function getAppointments(status,consultantKey, page = 1,) {
            ...
            success: function(response) {
                ...
                if(response.success == 1){
                    ...
                    $("#pagination-links a").on("click", function(e) {
                        ...
                        getAppointments(status, consultantKey, newPage);
                    });
                }
