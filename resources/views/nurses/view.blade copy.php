            ...
            <div class="col-12 mb-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb d-inline-flex justify-content-center justify-content-sm-start">
                        <li class="breadcrumb-item"><a href="{{route('nurse.list')}}" class="primary">Nurses</a></li>
                        ...
                        <div class="row align-items-end h-100 p-3">
                            <div class="col-lg-5 col-xl-3">
                                <div class="user_details text-start">
                                    <img src="{{asset($nurse['logo_path'])}}" class="img-fluid">
                            ...
                            <div class="col-lg-7 col-xl-9">
                                <div class="d-flex justify-content-center justify-content-lg-end">
                                    ...
                                    <div class="btn_alignbox">
                                        <a href="{{'mailto:'. $nurse['email'] }}" class="btn btn-outline d-flex align-items-center justify-content-center gap-2"><span class="material-symbols-outlined"> mail </span>Email</a>
                ...
                <div class="web-card h-100 mb-3">
                    <div class="detailsList cardList">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <p>{{$countryCode->country_code. '    '. $nurse->phone_number}}</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="col-12">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link {{session()->get('type')=='online' || $type=='online' ? 'active': ''}}" id="pills-home-tab" onclick="online('online','upcoming')" data-url="{{route('nurse.appointmentList',[$nurse->clinic_user_uuid])}}" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Online Appointments</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link {{session()->get('type')=='offline' || $type=='offline' ? 'active': ''}}" id="pills-profile-tab" onclick="online('offline','upcoming')" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">In-person Appointments</button>
                                    </li>
                                </ul>
...
<script>
    ...
    function online(type, status, page = 1) {
        ...
        console.log(status);
        console.log(url);
        $('#table-offline').html('<div class="d-flex justify-content-center py-5"><img src="{{ asset("images/loader.gif") }}" width="250px"></div>');
        $.ajax({
            type: "get",
            url: url,
            data: {
