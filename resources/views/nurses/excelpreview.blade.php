                            ...
                            <div class="col-12 mb-3">
                                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                    <ol class="breadcrumb d-inline-flex justify-content-center justify-content-sm-start">
                                      <li class="breadcrumb-item"><a href="patientrecords.html" class="primary">Import Nurse</a></li>
                                    </ol>
                                  </nav>
                            </div>
        ...
        $.ajax({
            ...
            success: function(data) {
              if (data.success == 1) {
                ...
                window.location.href = "{{url('nurse/list')}}" ;
              } else {
                swal({
                  icon: 'error',
                  text: data.message,
