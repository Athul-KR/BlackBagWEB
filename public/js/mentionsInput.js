...
(function ($, _, undefined) {
    ...
    var MentionsInput = function (settings) {
        ...
        function updateValues() {
            ...
            if (elmMentionsOverlay && typeof elmMentionsOverlay.find === 'function') {
        ...
        function onInputBoxKeyDown(e) {
            ...
            if (elmAutocompleteList && typeof elmAutocompleteList.is === 'function') {
        ...
        function hideAutoComplete() {
            ...
            if (elmAutocompleteList && typeof elmAutocompleteList.empty === 'function') {
        ...
        function populateDropdown(query, results) {
            if (elmAutocompleteList && typeof elmAutocompleteList.show === 'function') {
